...
#pragma unroll
            for (int64_t i = 0; i < kCoarseningFactor; i++) {
                ...
                atomicAdd(&relation_grad[layer * dim + d], dx_drel);
                atomicAdd(&input_grad[col * dim + d], dx_din);
            }
...
DECLARE_FORWARD_IMPL(add, complex, NaryAdd, BinaryComplex)
DECLARE_BACKWARD_IMPL(add, complex, NaryAdd, BinaryComplex)
DECLARE_FORWARD_IMPL(min, complex, NaryMin, BinaryComplex)
DECLARE_BACKWARD_IMPL(min, complex, NaryMin, BinaryComplex)
DECLARE_FORWARD_IMPL(max, complex, NaryMax, BinaryComplex)
DECLARE_BACKWARD_IMPL(max, complex, NaryMax, BinaryComplex)

DECLARE_FORWARD_IMPL(add, split_complex, NaryAdd, BinarySplitComplex)
DECLARE_BACKWARD_IMPL(add, split_complex, NaryAdd, BinarySplitComplex)
DECLARE_FORWARD_IMPL(min, split_complex, NaryMin, BinarySplitComplex)
DECLARE_BACKWARD_IMPL(min, split_complex, NaryMin, BinarySplitComplex)
DECLARE_FORWARD_IMPL(max, split_complex, NaryMax, BinarySplitComplex)
DECLARE_BACKWARD_IMPL(max, split_complex, NaryMax, BinarySplitComplex)

DECLARE_FORWARD_IMPL(add, dual, NaryAdd, BinaryDual)
DECLARE_BACKWARD_IMPL(add, dual, NaryAdd, BinaryDual)
DECLARE_FORWARD_IMPL(min, dual, NaryMin, BinaryDual)
DECLARE_BACKWARD_IMPL(min, dual, NaryMin, BinaryDual)
DECLARE_FORWARD_IMPL(max, dual, NaryMax, BinaryDual)
DECLARE_BACKWARD_IMPL(max, dual, NaryMax, BinaryDual)
